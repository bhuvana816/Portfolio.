      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
          <AnimatedSection className="md:w-1/2">
            <motion.div
              className="w-60 h-60 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-indigo-200 dark:border-indigo-800 shadow-2xl ring-4 ring-indigo-300 dark:ring-indigo-700"
          ...
          <div className="md:w-1/2">
            ...
            <AnimatedSection delay={0.2}>
              <TypeAnimation
                ...
                speed={50}
                repeat={Infinity}
                className="text-xl md:text-2xl font-medium text-indigo-600 dark:text-indigo-400 mb-6"
              />
            </AnimatedSection>
